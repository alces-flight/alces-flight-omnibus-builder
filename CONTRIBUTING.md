# Contributing to Alces Flight Omnibus Builder

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Alces Flight Omnibus Builder? Welcome! Please read this
...
You can help Alces Flight Omnibus Builder by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/alces-flight/alces-flight-omnibus-builder/issues?state=open)
...
If you find a bug - behaviour of Alces Flight Omnibus Builder code or documentation
...
[GitHub issue tracker for Alces Flight Omnibus Builder](https://github.com/alces-flight/alces-flight-omnibus-builder/issues/new)
to report the issue.
...
We want to improve the quality of Alces Flight Omnibus Builder and good bug reports are
...
Alces Flight Omnibus Builder is Open Source and comes without warranty.
...
Alces Flight Omnibus Builder in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Alces Flight Omnibus Builder and really improve it. The more
...
applied to Alces Flight Omnibus Builder itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/alces-flight/alces-flight-omnibus-builder). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Alces Flight Omnibus Builder developers also have their regular
