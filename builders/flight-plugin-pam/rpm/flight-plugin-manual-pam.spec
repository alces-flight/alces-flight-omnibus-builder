...
Source0:        https://github.com/alces-flight/%{_flight_repo_name}/archive/%{version}.tar.gz
...
BuildRoot:      %{_tmppath}/%{_flight_repo_name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildArch:      x86_64
...
%prep
%setup -q -n %{_flight_repo_name}-%{version}
